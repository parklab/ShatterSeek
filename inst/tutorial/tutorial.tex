...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot\_chromothripsis(ShatterSeek\_output = chromothripsis, chr = "{}3"{}): unused argument (ShatterSeek\_output = chromothripsis)}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot\_chromothripsis(ShatterSeek\_output = chromothripsis, chr = "{}2"{}): unused argument (ShatterSeek\_output = chromothripsis)}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in arrangeGrob(plots\_chr2[[1]], plots\_chr2[[2]], plots\_chr2[[3]], : object 'plots\_chr2' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot\_chromothripsis(ShatterSeek\_output = chromothripsis, chr = "{}21"{}): unused argument (ShatterSeek\_output = chromothripsis)}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in arrangeGrob(plots\_chr21[[1]], plots\_chr21[[2]], plots\_chr21[[3]], : object 'plots\_chr21' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot\_chromothripsis(ShatterSeek\_output = chromothripsis, chr = "{}X"{}): unused argument (ShatterSeek\_output = chromothripsis)}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot\_grid(plot\_chr3, plot\_chr2): object 'plot\_chr3' not found}}\end{kframe}
\end{knitrout}
