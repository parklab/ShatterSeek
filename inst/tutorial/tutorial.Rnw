...
CN_data <- CNVsegs(chrom=as.character(SCNA_DO17373$chromosome),
                     ...
                     log2copyratio=SCNA_DO17373$total_cn)
@
...
<<echo=TRUE,warning=FALSE,message=FALSE,eval=TRUE,tidy=TRUE,render=T,fig.align='center',fig.cap="CV",out.width='8cm'>>=
library(ggplot2)
source("shatterSeek_0.4/R/plot_function.R")
plots = plot_chromothripsis(shatterSeek_output = chromothripsis,chr = 22)
